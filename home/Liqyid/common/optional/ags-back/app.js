...
import notification from "gi://AstalNotifd";
import { Widget, App } from "gi://Astal";
import {exec, idle, monitorFile} from "gi://Astal";
...
const Notification = notification.get_default()
...
monitorFile(`${App.configDir}/style`, reloadCss);
